...
// FinancialData SDK utility: make_options

class FinancialDataMakeOptions
{
    ...
    public static function call(FinancialDataContext $ctx): array
    {
        ...
        //
        // `FinancialDataSchema::optspec()` is built from the model:
        ...
        $optspec = FinancialDataSchema::optspec();
