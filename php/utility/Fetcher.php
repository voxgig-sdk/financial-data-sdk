...
// FinancialData SDK utility: fetcher
...
class FinancialDataFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FinancialDataSDK/1.0)';
    ...
    public static function call(FinancialDataContext $ctx, string $fullurl, array $fetchdef): array
    {
