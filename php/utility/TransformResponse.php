...
// FinancialData SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class FinancialDataTransformResponse
{
    public static function call(FinancialDataContext $ctx): mixed
    {
        ...
        $transform = FinancialDataHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
