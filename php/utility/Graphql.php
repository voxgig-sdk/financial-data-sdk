...
// FinancialData SDK utility: graphql
//
...
class FinancialDataGraphql
{
    ...
    // equivalent.
    public static function body(FinancialDataContext $ctx): mixed
    {
    ...
    public static function errors(FinancialDataContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
