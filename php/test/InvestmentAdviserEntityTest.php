...
class InvestmentAdviserEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set FINANCIALDATA_TEST_INVESTMENT_ADVISER_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function investment_adviser_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("FINANCIALDATA_TEST_INVESTMENT_ADVISER_ENTID");
