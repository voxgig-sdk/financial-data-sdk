...
class MarketNewDirectTest extends TestCase
{
    public function test_direct_load_market_new(): void
    {
        $setup = market_new_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-market_new", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
