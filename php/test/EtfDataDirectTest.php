...
class EtfDataDirectTest extends TestCase
{
    public function test_direct_load_etf_data(): void
    {
        $setup = etf_data_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-etf_data", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
