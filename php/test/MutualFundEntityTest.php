...
class MutualFundEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set FINANCIAL_DATA_TEST_MUTUAL_FUND_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function mutual_fund_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("FINANCIAL_DATA_TEST_MUTUAL_FUND_ENTID");
