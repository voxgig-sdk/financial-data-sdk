...
// FinancialData SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = FinancialDataOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(FinancialDataOmni::structfix($now, Struct::undef()))
                        !== json_encode(FinancialDataOmni::structfix($val, Struct::undef()))) {
