...
// FinancialData SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FinancialDataSDK::test)
...
{
    private const SDK_CLASS = 'FinancialDataSDK';
    ...
    private const SDK_BASE = 'financialdata_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../financialdata_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
