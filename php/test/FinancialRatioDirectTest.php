...
class FinancialRatioDirectTest extends TestCase
{
    public function test_direct_load_financial_ratio(): void
    {
        $setup = financial_ratio_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-financial_ratio", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
