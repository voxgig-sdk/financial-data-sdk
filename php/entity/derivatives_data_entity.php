...
// FinancialData SDK DerivativesData entity
...
class DerivativesDataEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DerivativesDataEntity($this->_client, $opts);
    }

    /**
     * @param DerivativesData|array $args DerivativesData data (assoc-array) to store.
     */
    ...
    /**
     * @return DerivativesData|array The current DerivativesData data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DerivativesData fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DerivativesData fields).
     */
     ...
     *
     * @param DerivativesDataLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DerivativesDataLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DerivativesData|array The loaded DerivativesData as an assoc-array at the
