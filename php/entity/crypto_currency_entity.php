...
// FinancialData SDK CryptoCurrency entity
...
class CryptoCurrencyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CryptoCurrencyEntity($this->_client, $opts);
    }

    /**
     * @param CryptoCurrency|array $args CryptoCurrency data (assoc-array) to store.
     */
    ...
    /**
     * @return CryptoCurrency|array The current CryptoCurrency data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CryptoCurrency fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CryptoCurrency fields).
     */
     ...
     *
     * @param CryptoCurrencyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CryptoCurrencyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CryptoCurrency|array The loaded CryptoCurrency as an assoc-array at the
