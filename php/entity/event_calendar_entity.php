...
// FinancialData SDK EventCalendar entity
...
class EventCalendarEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EventCalendarEntity($this->_client, $opts);
    }

    /**
     * @param EventCalendar|array $args EventCalendar data (assoc-array) to store.
     */
    ...
    /**
     * @return EventCalendar|array The current EventCalendar data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EventCalendar fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EventCalendar fields).
     */
     ...
     *
     * @param EventCalendarLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EventCalendarLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EventCalendar|array The loaded EventCalendar as an assoc-array at the
