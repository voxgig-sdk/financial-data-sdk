...
// FinancialData SDK MarketNew entity
...
class MarketNewEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MarketNewEntity($this->_client, $opts);
    }

    /**
     * @param MarketNew|array $args MarketNew data (assoc-array) to store.
     */
    ...
    /**
     * @return MarketNew|array The current MarketNew data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MarketNew fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MarketNew fields).
     */
     ...
     *
     * @param MarketNewLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MarketNewLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MarketNew|array The loaded MarketNew as an assoc-array at the
