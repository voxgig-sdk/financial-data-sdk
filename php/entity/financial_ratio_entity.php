...
// FinancialData SDK FinancialRatio entity
...
class FinancialRatioEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FinancialRatioEntity($this->_client, $opts);
    }

    /**
     * @param FinancialRatio|array $args FinancialRatio data (assoc-array) to store.
     */
    ...
    /**
     * @return FinancialRatio|array The current FinancialRatio data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of FinancialRatio fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of FinancialRatio fields).
     */
    ...
    /**
     * Load a single FinancialRatio.
     *
     * @param FinancialRatioLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed FinancialRatioLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FinancialRatio|array The loaded FinancialRatio as an assoc-array at the
