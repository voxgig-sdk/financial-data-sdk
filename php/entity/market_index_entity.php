...
// FinancialData SDK MarketIndex entity
...
class MarketIndexEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MarketIndexEntity($this->_client, $opts);
    }

    /**
     * @param MarketIndex|array $args MarketIndex data (assoc-array) to store.
     */
    ...
    /**
     * @return MarketIndex|array The current MarketIndex data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MarketIndex fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MarketIndex fields).
     */
    ...
    /**
     * Load a single MarketIndex.
     *
     * @param MarketIndexLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MarketIndexLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MarketIndex|array The loaded MarketIndex as an assoc-array at the
