...
// FinancialData SDK SymbolList entity
...
class SymbolListEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SymbolListEntity($this->_client, $opts);
    }

    /**
     * @param SymbolList|array $args SymbolList data (assoc-array) to store.
     */
    ...
    /**
     * @return SymbolList|array The current SymbolList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SymbolList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SymbolList fields).
     */
     ...
     *
     * @param SymbolListListMatch|array|null $reqmatch Match filter (any subset
     *   of SymbolList fields) as an assoc-array; SymbolListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SymbolList[]|array A list of SymbolList items as assoc-arrays at
     *   the SDK boundary; throws FinancialDataError on failure (item-5 convention).
     */
