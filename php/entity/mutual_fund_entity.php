...
// FinancialData SDK MutualFund entity
...
class MutualFundEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MutualFundEntity($this->_client, $opts);
    }

    /**
     * @param MutualFund|array $args MutualFund data (assoc-array) to store.
     */
    ...
    /**
     * @return MutualFund|array The current MutualFund data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MutualFund fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MutualFund fields).
     */
    ...
    /**
     * Load a single MutualFund.
     *
     * @param MutualFundLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MutualFundLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MutualFund|array The loaded MutualFund as an assoc-array at the
