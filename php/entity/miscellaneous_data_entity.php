...
// FinancialData SDK MiscellaneousData entity
...
class MiscellaneousDataEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MiscellaneousDataEntity($this->_client, $opts);
    }

    /**
     * @param MiscellaneousData|array $args MiscellaneousData data (assoc-array) to store.
     */
    ...
    /**
     * @return MiscellaneousData|array The current MiscellaneousData data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MiscellaneousData fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MiscellaneousData fields).
     */
    ...
    /**
     * Load a single MiscellaneousData.
     *
     * @param MiscellaneousDataLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MiscellaneousDataLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MiscellaneousData|array The loaded MiscellaneousData as an assoc-array at the
