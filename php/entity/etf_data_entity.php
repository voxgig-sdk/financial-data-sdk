...
// FinancialData SDK EtfData entity
...
class EtfDataEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EtfDataEntity($this->_client, $opts);
    }

    /**
     * @param EtfData|array $args EtfData data (assoc-array) to store.
     */
    ...
    /**
     * @return EtfData|array The current EtfData data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EtfData fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EtfData fields).
     */
    ...
    /**
     * Load a single EtfData.
     *
     * @param EtfDataLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EtfDataLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EtfData|array The loaded EtfData as an assoc-array at the
