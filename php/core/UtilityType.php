...
// FinancialData SDK utility type

class FinancialDataUtility
{
    ...
    public static function copy(FinancialDataUtility $src): FinancialDataUtility
    {
        $u = new FinancialDataUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
