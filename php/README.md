...
The PHP SDK for the FinancialData API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->BasicInformation(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->FinancialData(null)->load(
    ["id" => "test01"], null
);
