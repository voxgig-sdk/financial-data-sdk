...
// FinancialData SDK proxy feature
...
class FinancialDataProxyFeature extends FinancialDataBaseFeature
{
    ...
    public function init(FinancialDataContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FinancialDataContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
