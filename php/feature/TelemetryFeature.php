...
// FinancialData SDK telemetry feature
...
class FinancialDataTelemetryFeature extends FinancialDataBaseFeature
{
    ...
    private function _close(FinancialDataContext $ctx, bool $ok): void
    {
