...
// FinancialData SDK clienttrack feature
...
class FinancialDataClienttrackFeature extends FinancialDataBaseFeature
{
    ...
    public function PostConstruct(FinancialDataContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FinancialData-SDK';
