...
// FinancialData SDK metrics feature
...
class FinancialDataMetricsFeature extends FinancialDataBaseFeature
{
    ...
    private function _record(FinancialDataContext $ctx, bool $ok): void
    {
