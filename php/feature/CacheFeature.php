...
// FinancialData SDK cache feature
...
class FinancialDataCacheFeature extends FinancialDataBaseFeature
{
    ...
    private function _through(FinancialDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
