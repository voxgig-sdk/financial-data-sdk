...
// FinancialData SDK debug feature
...
class FinancialDataDebugFeature extends FinancialDataBaseFeature
{
    ...
    private function _finish(FinancialDataContext $ctx, bool $ok): void
    {
