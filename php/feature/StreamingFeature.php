...
// FinancialData SDK streaming feature
...
class FinancialDataStreamingFeature extends FinancialDataBaseFeature
{
    ...
    private function _iterate(FinancialDataResult $result): \Generator
    {
    ...
    private function _streamable(FinancialDataContext $ctx): bool
    {
