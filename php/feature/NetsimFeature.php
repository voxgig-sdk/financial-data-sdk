...
// FinancialData SDK netsim feature
...
class FinancialDataNetsimFeature extends FinancialDataBaseFeature
{
    ...
    private function _simulate(FinancialDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FinancialDataContext $ctx, array $applied): void
    {
        $client = $this->client;
