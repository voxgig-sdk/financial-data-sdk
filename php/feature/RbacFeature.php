...
// FinancialData SDK rbac feature
...
class FinancialDataRbacFeature extends FinancialDataBaseFeature
{
    ...
    private function _required(FinancialDataContext $ctx): ?string
    {
    ...
    private function _reject(FinancialDataContext $ctx, string $required): void
    {
    ...
    private function _track(FinancialDataContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
