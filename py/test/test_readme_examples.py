# FinancialData SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FinancialDataSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FinancialDataSDK(...) and FinancialDataSDK.test(...) become
#      FinancialDataSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "financialdata_sdk"
_SDK_CLASS = "FinancialDataSDK"
...
_ENTITIES = {
    ...
    "DerivativesData": "derivatives_data",
    "EsgData": "esg_data",
    "EtfData": "etf_data",
    ...
    "InstitutionalTrading": "institutional_trading",
    "InvestmentAdviser": "investment_adviser",
    "MarketData": "market_data",
    "MarketIndex": "market_index",
    "MarketNew": "market_new",
    "MiscellaneousData": "miscellaneous_data",
