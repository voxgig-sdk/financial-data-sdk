...
class FinancialDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FinancialDataTestRunner.getenv("FINANCIALDATA_TEST_LIVE")
        override = FinancialDataTestRunner.getenv("FINANCIALDATA_TEST_OVERRIDE")
        ...
        explain = FinancialDataTestRunner.getenv("FINANCIALDATA_TEST_EXPLAIN")
