...
from financialdata_sdk.core.control import FinancialDataControl
...
from financialdata_sdk.core.helpers import get_ctx_prop, to_map
...
class FinancialDataContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = FinancialDataControl()
        ...
        if isinstance(sp, FinancialDataSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FinancialDataResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FinancialDataResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return FinancialDataError(code, msg, self)
