...
class FinancialStatementEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return FinancialStatementEntity(self._client, opts)
    ...
    def data_get(self) -> FinancialStatement:
    ...
    def match_get(self) -> FinancialStatement:
    ...
    def load(self, reqmatch=None, ctrl=None) -> FinancialStatement:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.FinancialStatement().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
