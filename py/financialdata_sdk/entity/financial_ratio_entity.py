...
class FinancialRatioEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return FinancialRatioEntity(self._client, opts)
    ...
    def data_get(self) -> FinancialRatio:
    ...
    def match_get(self) -> FinancialRatio:
    ...
    def load(self, reqmatch=None, ctrl=None) -> FinancialRatio:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.FinancialRatio().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
