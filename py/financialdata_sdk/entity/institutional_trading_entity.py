...
from financialdata_sdk.financialdata_types import (
...
class InstitutionalTradingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return InstitutionalTradingEntity(self._client, opts)
    ...
    def data_get(self) -> InstitutionalTrading:
    ...
    def match_get(self) -> InstitutionalTrading:
    ...
    def load(self, reqmatch=None, ctrl=None) -> InstitutionalTrading:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.InstitutionalTrading().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
