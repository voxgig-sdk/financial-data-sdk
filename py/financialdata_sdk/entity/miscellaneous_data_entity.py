...
class MiscellaneousDataEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MiscellaneousDataEntity(self._client, opts)
    ...
    def data_get(self) -> MiscellaneousData:
    ...
    def match_get(self) -> MiscellaneousData:
    ...
    def load(self, reqmatch=None, ctrl=None) -> MiscellaneousData:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.MiscellaneousData().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
