...
class DerivativesDataEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DerivativesDataEntity(self._client, opts)
    ...
    def data_get(self) -> DerivativesData:
    ...
    def match_get(self) -> DerivativesData:
    ...
    def load(self, reqmatch=None, ctrl=None) -> DerivativesData:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.DerivativesData().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
