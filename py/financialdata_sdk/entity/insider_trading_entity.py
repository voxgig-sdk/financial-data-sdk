...
class InsiderTradingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return InsiderTradingEntity(self._client, opts)
    ...
    def data_get(self) -> InsiderTrading:
    ...
    def match_get(self) -> InsiderTrading:
    ...
    def load(self, reqmatch=None, ctrl=None) -> InsiderTrading:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.InsiderTrading().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
