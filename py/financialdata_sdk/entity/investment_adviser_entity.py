...
class InvestmentAdviserEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return InvestmentAdviserEntity(self._client, opts)
    ...
    def data_get(self) -> InvestmentAdviser:
    ...
    def match_get(self) -> InvestmentAdviser:
    ...
    def load(self, reqmatch=None, ctrl=None) -> InvestmentAdviser:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.InvestmentAdviser().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
