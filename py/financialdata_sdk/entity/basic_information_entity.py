...
class BasicInformationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BasicInformationEntity(self._client, opts)
    ...
    def data_get(self) -> BasicInformation:
    ...
    def match_get(self) -> BasicInformation:
    ...
    def load(self, reqmatch=None, ctrl=None) -> BasicInformation:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.BasicInformation().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
