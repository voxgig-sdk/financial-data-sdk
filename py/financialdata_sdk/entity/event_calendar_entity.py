...
class EventCalendarEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EventCalendarEntity(self._client, opts)
    ...
    def data_get(self) -> EventCalendar:
    ...
    def match_get(self) -> EventCalendar:
    ...
    def load(self, reqmatch=None, ctrl=None) -> EventCalendar:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.EventCalendar().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
