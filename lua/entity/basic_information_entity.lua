...
local BasicInformationEntity = {}
BasicInformationEntity.__index = BasicInformationEntity


function BasicInformationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BasicInformationEntity)
  self._name = "basic_information"
  self._client = client
...
function BasicInformationEntity:get_name()
  return self._name
end


function BasicInformationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BasicInformationEntity.new(self._client, opts)
end
...
function BasicInformationEntity:mark_deleted()
  self._deleted = true
end


function BasicInformationEntity:deleted()
  return true == self._deleted
end


function BasicInformationEntity:data_set(args)
  if args ~= nil then
...
function BasicInformationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BasicInformationEntity:match_set(args)
  if args ~= nil then
...
function BasicInformationEntity:match_get()
...
function BasicInformationEntity:stream(action, args, callopts)
...
---@param reqmatch BasicInformationLoadMatch
---@param ctrl? table
---@return BasicInformation
---@return string? err
function BasicInformationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function BasicInformationEntity:_run_op(ctx, post_done)
  local utility = self._utility
