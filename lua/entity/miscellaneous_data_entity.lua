...
local MiscellaneousDataEntity = {}
MiscellaneousDataEntity.__index = MiscellaneousDataEntity


function MiscellaneousDataEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MiscellaneousDataEntity)
  self._name = "miscellaneous_data"
  self._client = client
...
function MiscellaneousDataEntity:get_name()
  return self._name
end


function MiscellaneousDataEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MiscellaneousDataEntity.new(self._client, opts)
end
...
function MiscellaneousDataEntity:mark_deleted()
  self._deleted = true
end


function MiscellaneousDataEntity:deleted()
  return true == self._deleted
end


function MiscellaneousDataEntity:data_set(args)
  if args ~= nil then
...
function MiscellaneousDataEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MiscellaneousDataEntity:match_set(args)
  if args ~= nil then
...
function MiscellaneousDataEntity:match_get()
...
function MiscellaneousDataEntity:stream(action, args, callopts)
...
---@param reqmatch MiscellaneousDataLoadMatch
---@param ctrl? table
---@return MiscellaneousData
---@return string? err
function MiscellaneousDataEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function MiscellaneousDataEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MiscellaneousDataEntity
