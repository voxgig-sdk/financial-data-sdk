...
local FinancialStatementEntity = {}
FinancialStatementEntity.__index = FinancialStatementEntity


function FinancialStatementEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, FinancialStatementEntity)
  self._name = "financial_statement"
  self._client = client
...
function FinancialStatementEntity:get_name()
  return self._name
end


function FinancialStatementEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return FinancialStatementEntity.new(self._client, opts)
end
...
function FinancialStatementEntity:mark_deleted()
  self._deleted = true
end


function FinancialStatementEntity:deleted()
  return true == self._deleted
end


function FinancialStatementEntity:data_set(args)
  if args ~= nil then
...
function FinancialStatementEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function FinancialStatementEntity:match_set(args)
  if args ~= nil then
...
function FinancialStatementEntity:match_get()
...
function FinancialStatementEntity:stream(action, args, callopts)
...
function FinancialStatementEntity:_run_op(ctx, post_done)
  local utility = self._utility
