...
local InvestmentAdviserEntity = {}
InvestmentAdviserEntity.__index = InvestmentAdviserEntity


function InvestmentAdviserEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, InvestmentAdviserEntity)
  self._name = "investment_adviser"
  self._client = client
...
function InvestmentAdviserEntity:get_name()
  return self._name
end


function InvestmentAdviserEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return InvestmentAdviserEntity.new(self._client, opts)
end
...
function InvestmentAdviserEntity:mark_deleted()
  self._deleted = true
end


function InvestmentAdviserEntity:deleted()
  return true == self._deleted
end


function InvestmentAdviserEntity:data_set(args)
  if args ~= nil then
...
function InvestmentAdviserEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function InvestmentAdviserEntity:match_set(args)
  if args ~= nil then
...
function InvestmentAdviserEntity:match_get()
...
function InvestmentAdviserEntity:stream(action, args, callopts)
...
---@param reqmatch InvestmentAdviserLoadMatch
---@param ctrl? table
---@return InvestmentAdviser
---@return string? err
function InvestmentAdviserEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function InvestmentAdviserEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return InvestmentAdviserEntity
