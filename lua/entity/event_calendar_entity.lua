...
local EventCalendarEntity = {}
EventCalendarEntity.__index = EventCalendarEntity


function EventCalendarEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EventCalendarEntity)
  self._name = "event_calendar"
  self._client = client
...
function EventCalendarEntity:get_name()
  return self._name
end


function EventCalendarEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EventCalendarEntity.new(self._client, opts)
end
...
function EventCalendarEntity:mark_deleted()
  self._deleted = true
end


function EventCalendarEntity:deleted()
  return true == self._deleted
end


function EventCalendarEntity:data_set(args)
  if args ~= nil then
...
function EventCalendarEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EventCalendarEntity:match_set(args)
  if args ~= nil then
...
function EventCalendarEntity:match_get()
...
function EventCalendarEntity:stream(action, args, callopts)
...
---@param reqmatch EventCalendarLoadMatch
---@param ctrl? table
---@return EventCalendar
---@return string? err
function EventCalendarEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function EventCalendarEntity:_run_op(ctx, post_done)
  local utility = self._utility
