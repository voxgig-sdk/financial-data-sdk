...
local DerivativesDataEntity = {}
DerivativesDataEntity.__index = DerivativesDataEntity


function DerivativesDataEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DerivativesDataEntity)
  self._name = "derivatives_data"
  self._client = client
...
function DerivativesDataEntity:get_name()
  return self._name
end


function DerivativesDataEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DerivativesDataEntity.new(self._client, opts)
end
...
function DerivativesDataEntity:mark_deleted()
  self._deleted = true
end


function DerivativesDataEntity:deleted()
  return true == self._deleted
end


function DerivativesDataEntity:data_set(args)
  if args ~= nil then
...
function DerivativesDataEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DerivativesDataEntity:match_set(args)
  if args ~= nil then
...
function DerivativesDataEntity:match_get()
...
function DerivativesDataEntity:stream(action, args, callopts)
...
---@param reqmatch DerivativesDataLoadMatch
---@param ctrl? table
---@return DerivativesData
---@return string? err
function DerivativesDataEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function DerivativesDataEntity:_run_op(ctx, post_done)
  local utility = self._utility
