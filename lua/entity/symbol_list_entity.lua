...
local SymbolListEntity = {}
SymbolListEntity.__index = SymbolListEntity


function SymbolListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SymbolListEntity)
  self._name = "symbol_list"
  self._client = client
...
function SymbolListEntity:get_name()
  return self._name
end


function SymbolListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SymbolListEntity.new(self._client, opts)
end
...
function SymbolListEntity:mark_deleted()
  self._deleted = true
end


function SymbolListEntity:deleted()
  return true == self._deleted
end


function SymbolListEntity:data_set(args)
  if args ~= nil then
...
function SymbolListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SymbolListEntity:match_set(args)
  if args ~= nil then
...
function SymbolListEntity:match_get()
...
function SymbolListEntity:stream(action, args, callopts)
...
function SymbolListEntity:_run_op(ctx, post_done)
  local utility = self._utility
