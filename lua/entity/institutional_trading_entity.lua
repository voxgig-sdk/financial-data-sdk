...
local InstitutionalTradingEntity = {}
InstitutionalTradingEntity.__index = InstitutionalTradingEntity


function InstitutionalTradingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, InstitutionalTradingEntity)
  self._name = "institutional_trading"
  self._client = client
...
function InstitutionalTradingEntity:get_name()
  return self._name
end


function InstitutionalTradingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return InstitutionalTradingEntity.new(self._client, opts)
end
...
function InstitutionalTradingEntity:mark_deleted()
  self._deleted = true
end


function InstitutionalTradingEntity:deleted()
  return true == self._deleted
end


function InstitutionalTradingEntity:data_set(args)
  if args ~= nil then
...
function InstitutionalTradingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function InstitutionalTradingEntity:match_set(args)
  if args ~= nil then
...
function InstitutionalTradingEntity:match_get()
...
function InstitutionalTradingEntity:stream(action, args, callopts)
...
function InstitutionalTradingEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return InstitutionalTradingEntity
