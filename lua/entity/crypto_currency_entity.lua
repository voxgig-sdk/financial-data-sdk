...
local CryptoCurrencyEntity = {}
CryptoCurrencyEntity.__index = CryptoCurrencyEntity


function CryptoCurrencyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CryptoCurrencyEntity)
  self._name = "crypto_currency"
  self._client = client
...
function CryptoCurrencyEntity:get_name()
  return self._name
end


function CryptoCurrencyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CryptoCurrencyEntity.new(self._client, opts)
end
...
function CryptoCurrencyEntity:mark_deleted()
  self._deleted = true
end


function CryptoCurrencyEntity:deleted()
  return true == self._deleted
end


function CryptoCurrencyEntity:data_set(args)
  if args ~= nil then
...
function CryptoCurrencyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CryptoCurrencyEntity:match_set(args)
  if args ~= nil then
...
function CryptoCurrencyEntity:match_get()
...
function CryptoCurrencyEntity:stream(action, args, callopts)
...
---@param reqmatch CryptoCurrencyLoadMatch
---@param ctrl? table
---@return CryptoCurrency
---@return string? err
function CryptoCurrencyEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function CryptoCurrencyEntity:_run_op(ctx, post_done)
  local utility = self._utility
