...
local InsiderTradingEntity = {}
InsiderTradingEntity.__index = InsiderTradingEntity


function InsiderTradingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, InsiderTradingEntity)
  self._name = "insider_trading"
  self._client = client
...
function InsiderTradingEntity:get_name()
  return self._name
end


function InsiderTradingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return InsiderTradingEntity.new(self._client, opts)
end
...
function InsiderTradingEntity:mark_deleted()
  self._deleted = true
end


function InsiderTradingEntity:deleted()
  return true == self._deleted
end


function InsiderTradingEntity:data_set(args)
  if args ~= nil then
...
function InsiderTradingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function InsiderTradingEntity:match_set(args)
  if args ~= nil then
...
function InsiderTradingEntity:match_get()
...
function InsiderTradingEntity:stream(action, args, callopts)
...
function InsiderTradingEntity:_run_op(ctx, post_done)
  local utility = self._utility
