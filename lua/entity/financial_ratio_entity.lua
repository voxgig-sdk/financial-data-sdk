...
local FinancialRatioEntity = {}
FinancialRatioEntity.__index = FinancialRatioEntity


function FinancialRatioEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, FinancialRatioEntity)
  self._name = "financial_ratio"
  self._client = client
...
function FinancialRatioEntity:get_name()
  return self._name
end


function FinancialRatioEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return FinancialRatioEntity.new(self._client, opts)
end
...
function FinancialRatioEntity:mark_deleted()
  self._deleted = true
end


function FinancialRatioEntity:deleted()
  return true == self._deleted
end


function FinancialRatioEntity:data_set(args)
  if args ~= nil then
...
function FinancialRatioEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function FinancialRatioEntity:match_set(args)
  if args ~= nil then
...
function FinancialRatioEntity:match_get()
...
function FinancialRatioEntity:stream(action, args, callopts)
...
---@param reqmatch FinancialRatioLoadMatch
---@param ctrl? table
---@return FinancialRatio
---@return string? err
function FinancialRatioEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function FinancialRatioEntity:_run_op(ctx, post_done)
  local utility = self._utility
