...
describe("EsgDataDirect", function()
  it("should direct-load-esg_data", function()
    local setup = esg_data_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-esg_data", setup.live and "live" or "unit")
...
function esg_data_direct_setup(mockres)
