-- InstitutionalTrading direct test
...
describe("InstitutionalTradingDirect", function()
  it("should direct-load-institutional_trading", function()
    local setup = institutional_trading_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-institutional_trading", setup.live and "live" or "unit")
...
function institutional_trading_direct_setup(mockres)
