...
describe("EtfDataDirect", function()
  it("should direct-load-etf_data", function()
    local setup = etf_data_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-etf_data", setup.live and "live" or "unit")
...
function etf_data_direct_setup(mockres)
