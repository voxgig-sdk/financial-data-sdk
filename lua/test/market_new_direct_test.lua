...
describe("MarketNewDirect", function()
  it("should direct-load-market_new", function()
    local setup = market_new_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-market_new", setup.live and "live" or "unit")
...
function market_new_direct_setup(mockres)
