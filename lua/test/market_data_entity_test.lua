...
describe("MarketDataEntity", function()
  ...
  it("should stream", function()
    ...
    local seen = {}
    for item in base:MarketData(nil):stream("list", nil, nil) do
    ...
    if type(config.feature) == "table" and config.feature.streaming ~= nil then
      ...
      local got = {}
      for item in streamsdk:MarketData(nil):stream("list", nil, nil) do
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set FINANCIAL_DATA_TEST_MARKET_DATA_ENTID JSON to run live")
      return
    end
...
function market_data_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("FINANCIAL_DATA_TEST_MARKET_DATA_ENTID")
