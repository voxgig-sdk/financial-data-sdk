...
describe("CryptoCurrencyDirect", function()
  it("should direct-load-crypto_currency", function()
    local setup = crypto_currency_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-crypto_currency", setup.live and "live" or "unit")
...
function crypto_currency_direct_setup(mockres)
