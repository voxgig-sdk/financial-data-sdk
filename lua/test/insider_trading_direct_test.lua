...
describe("InsiderTradingDirect", function()
  it("should direct-load-insider_trading", function()
    local setup = insider_trading_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-insider_trading", setup.live and "live" or "unit")
...
function insider_trading_direct_setup(mockres)
