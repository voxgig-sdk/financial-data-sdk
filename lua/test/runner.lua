...
function runner.env_override(m)
  local live = runner.getenv("FINANCIAL_DATA_TEST_LIVE")
  local override = runner.getenv("FINANCIAL_DATA_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FINANCIAL_DATA_TEST_EXPLAIN")
