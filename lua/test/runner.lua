...
function runner.env_override(m)
  local live = runner.getenv("FINANCIALDATA_TEST_LIVE")
  local override = runner.getenv("FINANCIALDATA_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FINANCIALDATA_TEST_EXPLAIN")
