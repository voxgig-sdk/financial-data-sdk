-- FinancialStatement direct test
...
describe("FinancialStatementDirect", function()
  it("should direct-load-financial_statement", function()
    local setup = financial_statement_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-financial_statement", setup.live and "live" or "unit")
...
function financial_statement_direct_setup(mockres)
