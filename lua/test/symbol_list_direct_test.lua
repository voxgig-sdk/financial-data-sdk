...
describe("SymbolListDirect", function()
  it("should direct-list-symbol_list", function()
    local setup = symbol_list_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-symbol_list", setup.live and "live" or "unit")
