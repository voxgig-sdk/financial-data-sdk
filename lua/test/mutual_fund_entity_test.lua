...
describe("MutualFundEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set FINANCIALDATA_TEST_MUTUAL_FUND_ENTID JSON to run live")
      return
    end
...
function mutual_fund_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("FINANCIALDATA_TEST_MUTUAL_FUND_ENTID")
