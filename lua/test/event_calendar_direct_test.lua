...
describe("EventCalendarDirect", function()
  it("should direct-load-event_calendar", function()
    local setup = event_calendar_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-event_calendar", setup.live and "live" or "unit")
...
function event_calendar_direct_setup(mockres)
