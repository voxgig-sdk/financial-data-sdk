...
describe("MutualFundDirect", function()
  it("should direct-load-mutual_fund", function()
    local setup = mutual_fund_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-mutual_fund", setup.live and "live" or "unit")
...
function mutual_fund_direct_setup(mockres)
