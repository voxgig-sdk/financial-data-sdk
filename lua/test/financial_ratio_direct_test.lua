...
describe("FinancialRatioDirect", function()
  it("should direct-load-financial_ratio", function()
    local setup = financial_ratio_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-financial_ratio", setup.live and "live" or "unit")
...
function financial_ratio_direct_setup(mockres)
