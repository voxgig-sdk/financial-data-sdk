...
describe("MarketIndexDirect", function()
  it("should direct-load-market_index", function()
    local setup = market_index_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-market_index", setup.live and "live" or "unit")
