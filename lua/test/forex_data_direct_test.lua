...
describe("ForexDataDirect", function()
  it("should direct-load-forex_data", function()
    local setup = forex_data_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-forex_data", setup.live and "live" or "unit")
...
function forex_data_direct_setup(mockres)
