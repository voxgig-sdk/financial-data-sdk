...
describe("DerivativesDataDirect", function()
  it("should direct-load-derivatives_data", function()
    local setup = derivatives_data_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-derivatives_data", setup.live and "live" or "unit")
...
function derivatives_data_direct_setup(mockres)
