...
describe("MiscellaneousDataDirect", function()
  it("should direct-load-miscellaneous_data", function()
    local setup = miscellaneous_data_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-miscellaneous_data", setup.live and "live" or "unit")
...
function miscellaneous_data_direct_setup(mockres)
