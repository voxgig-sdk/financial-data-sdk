...
describe("BasicInformationDirect", function()
  it("should direct-load-basic_information", function()
    local setup = basic_information_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-basic_information", setup.live and "live" or "unit")
...
function basic_information_direct_setup(mockres)
