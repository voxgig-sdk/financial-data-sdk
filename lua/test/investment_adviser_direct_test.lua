...
describe("InvestmentAdviserDirect", function()
  it("should direct-load-investment_adviser", function()
    local setup = investment_adviser_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-investment_adviser", setup.live and "live" or "unit")
...
function investment_adviser_direct_setup(mockres)
