...
## Install
```bash
go get github.com/voxgig-sdk/financial-data-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/financial-data-sdk=../path/to/github.com/voxgig-sdk/financial-data-sdk
```
...
```
github.com/voxgig-sdk/financial-data-sdk/
...
The root package (`github.com/voxgig-sdk/financial-data-sdk`) re-exports everything needed
