...
func NewEtfDataEntity(client *core.FinancialDataSDK, entopts map[string]any) *EtfDataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EtfDataEntity) GetName() string { return e.name }
...
func (e *EtfDataEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EtfDataEntity) Deleted() bool {
	return e.deleted
}


func (e *EtfDataEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEtfDataEntity(e.client, opts)
}

func (e *EtfDataEntity) Data(args ...any) any {
...
func (e *EtfDataEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *EtfDataEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EtfDataEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *EtfDataEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EtfDataEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EtfDataEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EtfDataEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
