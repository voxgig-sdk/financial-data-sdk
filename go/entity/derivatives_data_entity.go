...
type DerivativesDataEntity struct {
	name    string
...
func NewDerivativesDataEntity(client *core.FinancialDataSDK, entopts map[string]any) *DerivativesDataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DerivativesDataEntity) GetName() string { return e.name }
...
func (e *DerivativesDataEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DerivativesDataEntity) Deleted() bool {
	return e.deleted
}


func (e *DerivativesDataEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDerivativesDataEntity(e.client, opts)
}

func (e *DerivativesDataEntity) Data(args ...any) any {
...
func (e *DerivativesDataEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DerivativesData; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DerivativesDataEntity) DataTyped(data ...DerivativesData) DerivativesData {
	if len(data) > 0 {
		return typedFrom[DerivativesData](e.Data(asMap(data[0])))
	}
	return typedFrom[DerivativesData](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DerivativesData (all fields
// optional at the wire level).
func (e *DerivativesDataEntity) MatchTyped(match ...DerivativesData) DerivativesData {
	if len(match) > 0 {
		return typedFrom[DerivativesData](e.Match(asMap(match[0])))
	}
	return typedFrom[DerivativesData](e.Match())
}
...
func (e *DerivativesDataEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DerivativesDataEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DerivativesDataLoadMatch and returns an DerivativesData. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DerivativesDataEntity) LoadTyped(reqmatch DerivativesDataLoadMatch, ctrl map[string]any) (DerivativesData, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return DerivativesData{}, err
	}
	return typedFrom[DerivativesData](res), nil
}



func (e *DerivativesDataEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DerivativesDataEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DerivativesDataEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DerivativesDataEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DerivativesDataEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
