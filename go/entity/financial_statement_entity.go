...
type FinancialStatementEntity struct {
	name    string
...
func NewFinancialStatementEntity(client *core.FinancialDataSDK, entopts map[string]any) *FinancialStatementEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FinancialStatementEntity) GetName() string { return e.name }
...
func (e *FinancialStatementEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FinancialStatementEntity) Deleted() bool {
	return e.deleted
}


func (e *FinancialStatementEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFinancialStatementEntity(e.client, opts)
}

func (e *FinancialStatementEntity) Data(args ...any) any {
...
func (e *FinancialStatementEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an FinancialStatement; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FinancialStatementEntity) DataTyped(data ...FinancialStatement) FinancialStatement {
	if len(data) > 0 {
		return typedFrom[FinancialStatement](e.Data(asMap(data[0])))
	}
	return typedFrom[FinancialStatement](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through FinancialStatement (all fields
// optional at the wire level).
func (e *FinancialStatementEntity) MatchTyped(match ...FinancialStatement) FinancialStatement {
	if len(match) > 0 {
		return typedFrom[FinancialStatement](e.Match(asMap(match[0])))
	}
	return typedFrom[FinancialStatement](e.Match())
}
...
func (e *FinancialStatementEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FinancialStatementEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FinancialStatementLoadMatch and returns an FinancialStatement. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FinancialStatementEntity) LoadTyped(reqmatch FinancialStatementLoadMatch, ctrl map[string]any) (FinancialStatement, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return FinancialStatement{}, err
	}
	return typedFrom[FinancialStatement](res), nil
}



func (e *FinancialStatementEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *FinancialStatementEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FinancialStatementEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FinancialStatementEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FinancialStatementEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
