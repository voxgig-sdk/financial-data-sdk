...
type BasicInformationEntity struct {
	name    string
...
func NewBasicInformationEntity(client *core.FinancialDataSDK, entopts map[string]any) *BasicInformationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BasicInformationEntity) GetName() string { return e.name }
...
func (e *BasicInformationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BasicInformationEntity) Deleted() bool {
	return e.deleted
}


func (e *BasicInformationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBasicInformationEntity(e.client, opts)
}

func (e *BasicInformationEntity) Data(args ...any) any {
...
func (e *BasicInformationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an BasicInformation; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BasicInformationEntity) DataTyped(data ...BasicInformation) BasicInformation {
	if len(data) > 0 {
		return typedFrom[BasicInformation](e.Data(asMap(data[0])))
	}
	return typedFrom[BasicInformation](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through BasicInformation (all fields
// optional at the wire level).
func (e *BasicInformationEntity) MatchTyped(match ...BasicInformation) BasicInformation {
	if len(match) > 0 {
		return typedFrom[BasicInformation](e.Match(asMap(match[0])))
	}
	return typedFrom[BasicInformation](e.Match())
}
...
func (e *BasicInformationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BasicInformationEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BasicInformationLoadMatch and returns an BasicInformation. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BasicInformationEntity) LoadTyped(reqmatch BasicInformationLoadMatch, ctrl map[string]any) (BasicInformation, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return BasicInformation{}, err
	}
	return typedFrom[BasicInformation](res), nil
}



func (e *BasicInformationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *BasicInformationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BasicInformationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BasicInformationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BasicInformationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
