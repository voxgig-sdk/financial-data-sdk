...
type InvestmentAdviserEntity struct {
	name    string
...
func NewInvestmentAdviserEntity(client *core.FinancialDataSDK, entopts map[string]any) *InvestmentAdviserEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *InvestmentAdviserEntity) GetName() string { return e.name }
...
func (e *InvestmentAdviserEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *InvestmentAdviserEntity) Deleted() bool {
	return e.deleted
}


func (e *InvestmentAdviserEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewInvestmentAdviserEntity(e.client, opts)
}

func (e *InvestmentAdviserEntity) Data(args ...any) any {
...
func (e *InvestmentAdviserEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an InvestmentAdviser; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *InvestmentAdviserEntity) DataTyped(data ...InvestmentAdviser) InvestmentAdviser {
	if len(data) > 0 {
		return typedFrom[InvestmentAdviser](e.Data(asMap(data[0])))
	}
	return typedFrom[InvestmentAdviser](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through InvestmentAdviser (all fields
// optional at the wire level).
func (e *InvestmentAdviserEntity) MatchTyped(match ...InvestmentAdviser) InvestmentAdviser {
	if len(match) > 0 {
		return typedFrom[InvestmentAdviser](e.Match(asMap(match[0])))
	}
	return typedFrom[InvestmentAdviser](e.Match())
}
...
func (e *InvestmentAdviserEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *InvestmentAdviserEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// InvestmentAdviserLoadMatch and returns an InvestmentAdviser. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *InvestmentAdviserEntity) LoadTyped(reqmatch InvestmentAdviserLoadMatch, ctrl map[string]any) (InvestmentAdviser, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return InvestmentAdviser{}, err
	}
	return typedFrom[InvestmentAdviser](res), nil
}



func (e *InvestmentAdviserEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *InvestmentAdviserEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *InvestmentAdviserEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *InvestmentAdviserEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *InvestmentAdviserEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
