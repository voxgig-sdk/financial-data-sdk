...
type InsiderTradingEntity struct {
	name    string
...
func NewInsiderTradingEntity(client *core.FinancialDataSDK, entopts map[string]any) *InsiderTradingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *InsiderTradingEntity) GetName() string { return e.name }
...
func (e *InsiderTradingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *InsiderTradingEntity) Deleted() bool {
	return e.deleted
}


func (e *InsiderTradingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewInsiderTradingEntity(e.client, opts)
}

func (e *InsiderTradingEntity) Data(args ...any) any {
...
func (e *InsiderTradingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an InsiderTrading; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *InsiderTradingEntity) DataTyped(data ...InsiderTrading) InsiderTrading {
	if len(data) > 0 {
		return typedFrom[InsiderTrading](e.Data(asMap(data[0])))
	}
	return typedFrom[InsiderTrading](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through InsiderTrading (all fields
// optional at the wire level).
func (e *InsiderTradingEntity) MatchTyped(match ...InsiderTrading) InsiderTrading {
	if len(match) > 0 {
		return typedFrom[InsiderTrading](e.Match(asMap(match[0])))
	}
	return typedFrom[InsiderTrading](e.Match())
}
...
func (e *InsiderTradingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *InsiderTradingEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// InsiderTradingLoadMatch and returns an InsiderTrading. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *InsiderTradingEntity) LoadTyped(reqmatch InsiderTradingLoadMatch, ctrl map[string]any) (InsiderTrading, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return InsiderTrading{}, err
	}
	return typedFrom[InsiderTrading](res), nil
}



func (e *InsiderTradingEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *InsiderTradingEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *InsiderTradingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *InsiderTradingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *InsiderTradingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
