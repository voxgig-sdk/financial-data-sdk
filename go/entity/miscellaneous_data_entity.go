...
type MiscellaneousDataEntity struct {
	name    string
...
func NewMiscellaneousDataEntity(client *core.FinancialDataSDK, entopts map[string]any) *MiscellaneousDataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MiscellaneousDataEntity) GetName() string { return e.name }
...
func (e *MiscellaneousDataEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MiscellaneousDataEntity) Deleted() bool {
	return e.deleted
}


func (e *MiscellaneousDataEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMiscellaneousDataEntity(e.client, opts)
}

func (e *MiscellaneousDataEntity) Data(args ...any) any {
...
func (e *MiscellaneousDataEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an MiscellaneousData; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MiscellaneousDataEntity) DataTyped(data ...MiscellaneousData) MiscellaneousData {
	if len(data) > 0 {
		return typedFrom[MiscellaneousData](e.Data(asMap(data[0])))
	}
	return typedFrom[MiscellaneousData](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through MiscellaneousData (all fields
// optional at the wire level).
func (e *MiscellaneousDataEntity) MatchTyped(match ...MiscellaneousData) MiscellaneousData {
	if len(match) > 0 {
		return typedFrom[MiscellaneousData](e.Match(asMap(match[0])))
	}
	return typedFrom[MiscellaneousData](e.Match())
}
...
func (e *MiscellaneousDataEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MiscellaneousDataEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MiscellaneousDataLoadMatch and returns an MiscellaneousData. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *MiscellaneousDataEntity) LoadTyped(reqmatch MiscellaneousDataLoadMatch, ctrl map[string]any) (MiscellaneousData, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return MiscellaneousData{}, err
	}
	return typedFrom[MiscellaneousData](res), nil
}



func (e *MiscellaneousDataEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *MiscellaneousDataEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MiscellaneousDataEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MiscellaneousDataEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MiscellaneousDataEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
