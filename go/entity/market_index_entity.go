...
func NewMarketIndexEntity(client *core.FinancialDataSDK, entopts map[string]any) *MarketIndexEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MarketIndexEntity) GetName() string { return e.name }
...
func (e *MarketIndexEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MarketIndexEntity) Deleted() bool {
	return e.deleted
}


func (e *MarketIndexEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMarketIndexEntity(e.client, opts)
}

func (e *MarketIndexEntity) Data(args ...any) any {
...
func (e *MarketIndexEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an MarketIndex; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MarketIndexEntity) DataTyped(data ...MarketIndex) MarketIndex {
	if len(data) > 0 {
		return typedFrom[MarketIndex](e.Data(asMap(data[0])))
	}
	return typedFrom[MarketIndex](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through MarketIndex (all fields
// optional at the wire level).
func (e *MarketIndexEntity) MatchTyped(match ...MarketIndex) MarketIndex {
	if len(match) > 0 {
		return typedFrom[MarketIndex](e.Match(asMap(match[0])))
	}
	return typedFrom[MarketIndex](e.Match())
}
...
func (e *MarketIndexEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MarketIndexEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MarketIndexLoadMatch and returns an MarketIndex. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *MarketIndexEntity) LoadTyped(reqmatch MarketIndexLoadMatch, ctrl map[string]any) (MarketIndex, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return MarketIndex{}, err
	}
	return typedFrom[MarketIndex](res), nil
}



func (e *MarketIndexEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *MarketIndexEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MarketIndexEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MarketIndexEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MarketIndexEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
