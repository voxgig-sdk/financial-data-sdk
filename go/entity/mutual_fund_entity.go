...
func NewMutualFundEntity(client *core.FinancialDataSDK, entopts map[string]any) *MutualFundEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MutualFundEntity) GetName() string { return e.name }
...
func (e *MutualFundEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MutualFundEntity) Deleted() bool {
	return e.deleted
}


func (e *MutualFundEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMutualFundEntity(e.client, opts)
}

func (e *MutualFundEntity) Data(args ...any) any {
...
func (e *MutualFundEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an MutualFund; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MutualFundEntity) DataTyped(data ...MutualFund) MutualFund {
	if len(data) > 0 {
		return typedFrom[MutualFund](e.Data(asMap(data[0])))
	}
	return typedFrom[MutualFund](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through MutualFund (all fields
// optional at the wire level).
func (e *MutualFundEntity) MatchTyped(match ...MutualFund) MutualFund {
	if len(match) > 0 {
		return typedFrom[MutualFund](e.Match(asMap(match[0])))
	}
	return typedFrom[MutualFund](e.Match())
}
...
func (e *MutualFundEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MutualFundEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MutualFundLoadMatch and returns an MutualFund. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *MutualFundEntity) LoadTyped(reqmatch MutualFundLoadMatch, ctrl map[string]any) (MutualFund, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return MutualFund{}, err
	}
	return typedFrom[MutualFund](res), nil
}



func (e *MutualFundEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *MutualFundEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MutualFundEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MutualFundEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MutualFundEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
