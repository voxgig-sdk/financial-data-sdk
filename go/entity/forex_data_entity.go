...
func NewForexDataEntity(client *core.FinancialDataSDK, entopts map[string]any) *ForexDataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ForexDataEntity) GetName() string { return e.name }
...
func (e *ForexDataEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ForexDataEntity) Deleted() bool {
	return e.deleted
}


func (e *ForexDataEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewForexDataEntity(e.client, opts)
}

func (e *ForexDataEntity) Data(args ...any) any {
...
func (e *ForexDataEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ForexData; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ForexDataEntity) DataTyped(data ...ForexData) ForexData {
	if len(data) > 0 {
		return typedFrom[ForexData](e.Data(asMap(data[0])))
	}
	return typedFrom[ForexData](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ForexData (all fields
// optional at the wire level).
func (e *ForexDataEntity) MatchTyped(match ...ForexData) ForexData {
	if len(match) > 0 {
		return typedFrom[ForexData](e.Match(asMap(match[0])))
	}
	return typedFrom[ForexData](e.Match())
}
...
func (e *ForexDataEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ForexDataEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ForexDataLoadMatch and returns an ForexData. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ForexDataEntity) LoadTyped(reqmatch ForexDataLoadMatch, ctrl map[string]any) (ForexData, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ForexData{}, err
	}
	return typedFrom[ForexData](res), nil
}



func (e *ForexDataEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ForexDataEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ForexDataEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ForexDataEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ForexDataEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
