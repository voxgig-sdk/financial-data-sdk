...
type FinancialRatioEntity struct {
	name    string
...
func NewFinancialRatioEntity(client *core.FinancialDataSDK, entopts map[string]any) *FinancialRatioEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FinancialRatioEntity) GetName() string { return e.name }
...
func (e *FinancialRatioEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FinancialRatioEntity) Deleted() bool {
	return e.deleted
}


func (e *FinancialRatioEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFinancialRatioEntity(e.client, opts)
}

func (e *FinancialRatioEntity) Data(args ...any) any {
...
func (e *FinancialRatioEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an FinancialRatio; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FinancialRatioEntity) DataTyped(data ...FinancialRatio) FinancialRatio {
	if len(data) > 0 {
		return typedFrom[FinancialRatio](e.Data(asMap(data[0])))
	}
	return typedFrom[FinancialRatio](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through FinancialRatio (all fields
// optional at the wire level).
func (e *FinancialRatioEntity) MatchTyped(match ...FinancialRatio) FinancialRatio {
	if len(match) > 0 {
		return typedFrom[FinancialRatio](e.Match(asMap(match[0])))
	}
	return typedFrom[FinancialRatio](e.Match())
}
...
func (e *FinancialRatioEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FinancialRatioEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FinancialRatioLoadMatch and returns an FinancialRatio. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FinancialRatioEntity) LoadTyped(reqmatch FinancialRatioLoadMatch, ctrl map[string]any) (FinancialRatio, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return FinancialRatio{}, err
	}
	return typedFrom[FinancialRatio](res), nil
}



func (e *FinancialRatioEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *FinancialRatioEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FinancialRatioEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FinancialRatioEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FinancialRatioEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
