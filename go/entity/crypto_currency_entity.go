...
type CryptoCurrencyEntity struct {
	name    string
...
func NewCryptoCurrencyEntity(client *core.FinancialDataSDK, entopts map[string]any) *CryptoCurrencyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CryptoCurrencyEntity) GetName() string { return e.name }
...
func (e *CryptoCurrencyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CryptoCurrencyEntity) Deleted() bool {
	return e.deleted
}


func (e *CryptoCurrencyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCryptoCurrencyEntity(e.client, opts)
}

func (e *CryptoCurrencyEntity) Data(args ...any) any {
...
func (e *CryptoCurrencyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CryptoCurrency; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CryptoCurrencyEntity) DataTyped(data ...CryptoCurrency) CryptoCurrency {
	if len(data) > 0 {
		return typedFrom[CryptoCurrency](e.Data(asMap(data[0])))
	}
	return typedFrom[CryptoCurrency](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CryptoCurrency (all fields
// optional at the wire level).
func (e *CryptoCurrencyEntity) MatchTyped(match ...CryptoCurrency) CryptoCurrency {
	if len(match) > 0 {
		return typedFrom[CryptoCurrency](e.Match(asMap(match[0])))
	}
	return typedFrom[CryptoCurrency](e.Match())
}
...
func (e *CryptoCurrencyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CryptoCurrencyEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CryptoCurrencyLoadMatch and returns an CryptoCurrency. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CryptoCurrencyEntity) LoadTyped(reqmatch CryptoCurrencyLoadMatch, ctrl map[string]any) (CryptoCurrency, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CryptoCurrency{}, err
	}
	return typedFrom[CryptoCurrency](res), nil
}



func (e *CryptoCurrencyEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CryptoCurrencyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CryptoCurrencyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CryptoCurrencyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CryptoCurrencyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
