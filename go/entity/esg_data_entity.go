...
func NewEsgDataEntity(client *core.FinancialDataSDK, entopts map[string]any) *EsgDataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EsgDataEntity) GetName() string { return e.name }
...
func (e *EsgDataEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EsgDataEntity) Deleted() bool {
	return e.deleted
}


func (e *EsgDataEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEsgDataEntity(e.client, opts)
}

func (e *EsgDataEntity) Data(args ...any) any {
...
func (e *EsgDataEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EsgData; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EsgDataEntity) DataTyped(data ...EsgData) EsgData {
	if len(data) > 0 {
		return typedFrom[EsgData](e.Data(asMap(data[0])))
	}
	return typedFrom[EsgData](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EsgData (all fields
// optional at the wire level).
func (e *EsgDataEntity) MatchTyped(match ...EsgData) EsgData {
	if len(match) > 0 {
		return typedFrom[EsgData](e.Match(asMap(match[0])))
	}
	return typedFrom[EsgData](e.Match())
}
...
func (e *EsgDataEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EsgDataEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EsgDataLoadMatch and returns an EsgData. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *EsgDataEntity) LoadTyped(reqmatch EsgDataLoadMatch, ctrl map[string]any) (EsgData, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return EsgData{}, err
	}
	return typedFrom[EsgData](res), nil
}



func (e *EsgDataEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *EsgDataEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EsgDataEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EsgDataEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EsgDataEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
