...
type EventCalendarEntity struct {
	name    string
...
func NewEventCalendarEntity(client *core.FinancialDataSDK, entopts map[string]any) *EventCalendarEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EventCalendarEntity) GetName() string { return e.name }
...
func (e *EventCalendarEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EventCalendarEntity) Deleted() bool {
	return e.deleted
}


func (e *EventCalendarEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEventCalendarEntity(e.client, opts)
}

func (e *EventCalendarEntity) Data(args ...any) any {
...
func (e *EventCalendarEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EventCalendar; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EventCalendarEntity) DataTyped(data ...EventCalendar) EventCalendar {
	if len(data) > 0 {
		return typedFrom[EventCalendar](e.Data(asMap(data[0])))
	}
	return typedFrom[EventCalendar](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EventCalendar (all fields
// optional at the wire level).
func (e *EventCalendarEntity) MatchTyped(match ...EventCalendar) EventCalendar {
	if len(match) > 0 {
		return typedFrom[EventCalendar](e.Match(asMap(match[0])))
	}
	return typedFrom[EventCalendar](e.Match())
}
...
func (e *EventCalendarEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EventCalendarEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EventCalendarLoadMatch and returns an EventCalendar. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *EventCalendarEntity) LoadTyped(reqmatch EventCalendarLoadMatch, ctrl map[string]any) (EventCalendar, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return EventCalendar{}, err
	}
	return typedFrom[EventCalendar](res), nil
}



func (e *EventCalendarEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *EventCalendarEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EventCalendarEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EventCalendarEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EventCalendarEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
