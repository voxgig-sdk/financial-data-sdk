...
func NewMarketNewEntity(client *core.FinancialDataSDK, entopts map[string]any) *MarketNewEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MarketNewEntity) GetName() string { return e.name }
...
func (e *MarketNewEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MarketNewEntity) Deleted() bool {
	return e.deleted
}


func (e *MarketNewEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMarketNewEntity(e.client, opts)
}

func (e *MarketNewEntity) Data(args ...any) any {
...
func (e *MarketNewEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an MarketNew; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MarketNewEntity) DataTyped(data ...MarketNew) MarketNew {
	if len(data) > 0 {
		return typedFrom[MarketNew](e.Data(asMap(data[0])))
	}
	return typedFrom[MarketNew](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through MarketNew (all fields
// optional at the wire level).
func (e *MarketNewEntity) MatchTyped(match ...MarketNew) MarketNew {
	if len(match) > 0 {
		return typedFrom[MarketNew](e.Match(asMap(match[0])))
	}
	return typedFrom[MarketNew](e.Match())
}
...
func (e *MarketNewEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MarketNewEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MarketNewLoadMatch and returns an MarketNew. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *MarketNewEntity) LoadTyped(reqmatch MarketNewLoadMatch, ctrl map[string]any) (MarketNew, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return MarketNew{}, err
	}
	return typedFrom[MarketNew](res), nil
}



func (e *MarketNewEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *MarketNewEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MarketNewEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MarketNewEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MarketNewEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
