...
func TestFinancialStatementEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		financialStatementRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.financial_statement")))
...
func financial_statementBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("FINANCIAL_DATA_TEST_FINANCIAL_STATEMENT_ENTID")
	...
	idmapResolved := core.ToMapAny(env["FINANCIAL_DATA_TEST_FINANCIAL_STATEMENT_ENTID"])
