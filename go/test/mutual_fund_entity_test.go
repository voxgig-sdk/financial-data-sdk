...
func TestMutualFundEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set FINANCIALDATA_TEST_MUTUAL_FUND_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func mutual_fundBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("FINANCIALDATA_TEST_MUTUAL_FUND_ENTID")
