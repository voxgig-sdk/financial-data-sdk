...
func TestFinancialRatioEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		financialRatioRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.financial_ratio")))
...
func financial_ratioBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("FINANCIAL_DATA_TEST_FINANCIAL_RATIO_ENTID")
	...
	idmapResolved := core.ToMapAny(env["FINANCIAL_DATA_TEST_FINANCIAL_RATIO_ENTID"])
