...
const testSeed = `map[string]any{"entity": map[string]any{"basic_information": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "crypto_currency": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "derivatives_data": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "esg_data": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "etf_data": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "event_calendar": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "financial_ratio": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "financial_statement": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "forex_data": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "insider_trading": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "institutional_trading": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "investment_adviser": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "market_data": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "market_index": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "market_new": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "miscellaneous_data": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "mutual_fund": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "symbol_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
