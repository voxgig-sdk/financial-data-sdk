...
func TestMiscellaneousDataEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		miscellaneousDataRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.miscellaneous_data")))
...
func miscellaneous_dataBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("FINANCIAL_DATA_TEST_MISCELLANEOUS_DATA_ENTID")
	...
	idmapResolved := core.ToMapAny(env["FINANCIAL_DATA_TEST_MISCELLANEOUS_DATA_ENTID"])
