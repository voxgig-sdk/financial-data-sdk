...
func (sdk *FinancialDataSDK) OptionsMap() map[string]any {
...
func (sdk *FinancialDataSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *FinancialDataSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *FinancialDataSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FinancialDataSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *FinancialDataSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *FinancialDataSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("FinancialDataSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *FinancialDataSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FinancialDataSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("FinancialDataSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *FinancialDataSDK {
	...
	sdk := NewFinancialDataSDK(sdkopts)
	sdk.Mode = "test"
