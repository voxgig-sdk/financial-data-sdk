...
// instead of `sdk.NewFinancialDataSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *FinancialDataSDK  { return NewFinancialDataSDK(nil) }
func Test() *FinancialDataSDK { return TestSDK(nil, nil) }
