...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/financial-data` | `npm install @voxgig-sdk/financial-data` |
| Python | `voxgig-sdk-financial-data` | `pip install voxgig-sdk-financial-data` |
| PHP | `voxgig-sdk/financial-data` | `composer require voxgig-sdk/financial-data` |
| Golang | `github.com/voxgig-sdk/financial-data-sdk/go` | `go get github.com/voxgig-sdk/financial-data-sdk/go` |
| Ruby | `voxgig-sdk-financial-data` | `gem install voxgig-sdk-financial-data` |
| Lua | `voxgig-sdk-financial-data` | `luarocks install voxgig-sdk-financial-data` |
