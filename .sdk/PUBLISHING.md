...
|---|---|---|
| `ts/` | @voxgig-sdk/financial-data-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/financial-data-sdk \
      --repository voxgig-sdk/financial-data-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/financial-data-sdk` shows it, and
`npm trust revoke @voxgig-sdk/financial-data-sdk --id=<id>` removes it.
