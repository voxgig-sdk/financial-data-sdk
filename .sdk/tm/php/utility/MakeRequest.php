...
// FinancialData SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class FinancialDataMakeRequest
{
    public static function call(FinancialDataContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new FinancialDataResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new FinancialDataResponse($fetched);
        } else {
