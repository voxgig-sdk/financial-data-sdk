...
// FinancialData SDK audit feature
...
class FinancialDataAuditFeature extends FinancialDataBaseFeature
{
    ...
    private function _emit(FinancialDataContext $ctx, string $outcome): void
    {
