...
// FinancialData SDK idempotency feature
...
class FinancialDataIdempotencyFeature extends FinancialDataBaseFeature
{
    ...
    private function _mutating(FinancialDataContext $ctx): bool
    {
