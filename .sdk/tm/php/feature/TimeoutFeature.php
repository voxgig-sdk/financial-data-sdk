...
// FinancialData SDK timeout feature
...
class FinancialDataTimeoutFeature extends FinancialDataBaseFeature
{
    ...
    private function _with_timeout(FinancialDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FinancialDataContext $_ctx, float $ms): void
    {
        $client = $this->client;
