...
// FinancialData SDK ratelimit feature
...
class FinancialDataRatelimitFeature extends FinancialDataBaseFeature
{
    ...
    private function _acquire(FinancialDataContext $ctx): void
    {
    ...
    private function _track(FinancialDataContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
