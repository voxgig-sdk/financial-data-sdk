...
class FinancialDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FinancialDataTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = FinancialDataTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = FinancialDataTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
