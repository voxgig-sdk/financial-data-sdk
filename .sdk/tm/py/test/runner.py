...
class FinancialDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FinancialDataTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = FinancialDataTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = FinancialDataTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
