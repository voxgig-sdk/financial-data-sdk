...
//     (\`new FinancialDataSDK(...)\` / \`FinancialDataSDK.test(...)\` become
//     \`FinancialDataSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const SDK_NAME = 'FinancialDataSDK'
...
const TEST_SEED = {"entity":{"basic_information":{"test01":{"id":"test01"}},"crypto_currency":{"test01":{"id":"test01"}},"derivatives_data":{"test01":{"id":"test01"}},"esg_data":{"test01":{"id":"test01"}},"etf_data":{"test01":{"id":"test01"}},"event_calendar":{"test01":{"id":"test01"}},"financial_ratio":{"test01":{"id":"test01"}},"financial_statement":{"test01":{"id":"test01"}},"forex_data":{"test01":{"id":"test01"}},"insider_trading":{"test01":{"id":"test01"}},"institutional_trading":{"test01":{"id":"test01"}},"investment_adviser":{"test01":{"id":"test01"}},"market_data":{"test01":{"id":"test01"}},"market_index":{"test01":{"id":"test01"}},"market_new":{"test01":{"id":"test01"}},"miscellaneous_data":{"test01":{"id":"test01"}},"mutual_fund":{"test01":{"id":"test01"}},"symbol_list":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new FinancialDataSDK(...)\` and any
// \`FinancialDataSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+FinancialDataSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/FinancialDataSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
