...
class SymbolListEntity extends FinancialDataEntityBase_1.FinancialDataEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'symbol_list';
        this.name_ = 'symbol_list';
        this.Name = 'SymbolList';
    }
    make() {
        return new SymbolListEntity(this._client, this.entopts());
    }
...
exports.SymbolListEntity = SymbolListEntity;
//# sourceMappingURL=SymbolListEntity.js.map