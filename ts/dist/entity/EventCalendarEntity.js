...
exports.EventCalendarEntity = void 0;
const FinancialDataEntityBase_1 = require("../FinancialDataEntityBase");
// TODO: needs Entity superclass
class EventCalendarEntity extends FinancialDataEntityBase_1.FinancialDataEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'event_calendar';
        this.name_ = 'event_calendar';
        this.Name = 'EventCalendar';
    }
    make() {
        return new EventCalendarEntity(this._client, this.entopts());
    }
...
exports.EventCalendarEntity = EventCalendarEntity;
//# sourceMappingURL=EventCalendarEntity.js.map