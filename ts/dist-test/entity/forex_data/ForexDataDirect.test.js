...
(0, node_test_1.describe)('ForexDataDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-forex_data', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-forex_data', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['FINANCIAL_DATA_TEST_FOREX_DATA_ENTID'];
...
//# sourceMappingURL=ForexDataDirect.test.js.map