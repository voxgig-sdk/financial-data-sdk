...
(0, node_test_1.describe)('ForexDataEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'forex_data.' + op, live))
                return;
        }
        ...
        let forex_data_ref01_data = Object.values(setup.data.existing.forex_data)[0];
        // LOAD
        const forex_data_ref01_ent = client.ForexData();
        const forex_data_ref01_match_dt0 = {};
        const forex_data_ref01_data_dt0 = (await forex_data_ref01_ent.load(forex_data_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != forex_data_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/forex_data/ForexDataTestData.json');
    ...
    let idmap = transform(['forex_data01', 'forex_data02', 'forex_data03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['FINANCIAL_DATA_TEST_FOREX_DATA_ENTID'];
...
//# sourceMappingURL=ForexDataEntity.test.js.map