...
(0, node_test_1.describe)('MarketIndexDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-market_index', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-market_index', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'FINANCIAL_DATA_TEST_MARKET_INDEX_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['FINANCIAL_DATA_TEST_MARKET_INDEX_ENTID'];
...
//# sourceMappingURL=MarketIndexDirect.test.js.map