...
(0, node_test_1.describe)('EtfDataEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'etf_data.' + op, live))
                return;
        }
        ...
        let etf_data_ref01_data = Object.values(setup.data.existing.etf_data)[0];
        // LOAD
        const etf_data_ref01_ent = client.EtfData();
        const etf_data_ref01_match_dt0 = {};
        const etf_data_ref01_data_dt0 = (await etf_data_ref01_ent.load(etf_data_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != etf_data_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/etf_data/EtfDataTestData.json');
    ...
    let idmap = transform(['etf_data01', 'etf_data02', 'etf_data03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['FINANCIAL_DATA_TEST_ETF_DATA_ENTID'];
...
//# sourceMappingURL=EtfDataEntity.test.js.map