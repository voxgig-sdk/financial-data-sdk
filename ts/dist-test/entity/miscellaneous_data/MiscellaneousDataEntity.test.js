...
(0, node_test_1.describe)('MiscellaneousDataEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'miscellaneous_data.' + op, live))
                return;
        }
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set FINANCIAL_DATA_TEST_MISCELLANEOUS_DATA_ENTID JSON to run live');
            return;
        }
        ...
        let miscellaneous_data_ref01_data = Object.values(setup.data.existing.miscellaneous_data)[0];
        // LOAD
        const miscellaneous_data_ref01_ent = client.MiscellaneousData();
        const miscellaneous_data_ref01_match_dt0 = {};
        const miscellaneous_data_ref01_data_dt0 = (await miscellaneous_data_ref01_ent.load(miscellaneous_data_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != miscellaneous_data_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/miscellaneous_data/MiscellaneousDataTestData.json');
    ...
    let idmap = transform(['miscellaneous_data01', 'miscellaneous_data02', 'miscellaneous_data03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['FINANCIAL_DATA_TEST_MISCELLANEOUS_DATA_ENTID'];
...
//# sourceMappingURL=MiscellaneousDataEntity.test.js.map