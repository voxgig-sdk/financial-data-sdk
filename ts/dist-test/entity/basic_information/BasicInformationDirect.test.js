...
(0, node_test_1.describe)('BasicInformationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-basic_information', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-basic_information', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'FINANCIAL_DATA_TEST_BASIC_INFORMATION_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['FINANCIAL_DATA_TEST_BASIC_INFORMATION_ENTID'];
...
//# sourceMappingURL=BasicInformationDirect.test.js.map