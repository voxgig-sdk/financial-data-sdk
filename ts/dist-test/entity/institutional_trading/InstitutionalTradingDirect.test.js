...
(0, node_test_1.describe)('InstitutionalTradingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-institutional_trading', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-institutional_trading', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['FINANCIAL_DATA_TEST_INSTITUTIONAL_TRADING_ENTID'];
...
//# sourceMappingURL=InstitutionalTradingDirect.test.js.map