...
(0, node_test_1.describe)('InvestmentAdviserEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'investment_adviser.' + op, live))
                return;
        }
        ...
        let investment_adviser_ref01_data = Object.values(setup.data.existing.investment_adviser)[0];
        // LOAD
        const investment_adviser_ref01_ent = client.InvestmentAdviser();
        const investment_adviser_ref01_match_dt0 = {};
        const investment_adviser_ref01_data_dt0 = (await investment_adviser_ref01_ent.load(investment_adviser_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != investment_adviser_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/investment_adviser/InvestmentAdviserTestData.json');
    ...
    let idmap = transform(['investment_adviser01', 'investment_adviser02', 'investment_adviser03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['FINANCIAL_DATA_TEST_INVESTMENT_ADVISER_ENTID'];
...
//# sourceMappingURL=InvestmentAdviserEntity.test.js.map