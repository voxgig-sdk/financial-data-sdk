...
(0, node_test_1.describe)('InvestmentAdviserDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.FinancialDataSDK({
    ...
    (0, node_test_1.test)('direct-load-investment_adviser', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-investment_adviser', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.FINANCIAL_DATA_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'FINANCIAL_DATA_TEST_INVESTMENT_ADVISER_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.FinancialDataSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.FINANCIAL_DATA_APIKEY,
        }));
        let idmap = env['FINANCIAL_DATA_TEST_INVESTMENT_ADVISER_ENTID'];
    ...
    const client = new __1.FinancialDataSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=InvestmentAdviserDirect.test.js.map