...
(0, node_test_1.describe)('MarketNewDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-market_new', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-market_new', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['FINANCIAL_DATA_TEST_MARKET_NEW_ENTID'];
...
//# sourceMappingURL=MarketNewDirect.test.js.map