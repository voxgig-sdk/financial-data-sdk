...
(0, node_test_1.describe)('SymbolListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-symbol_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-symbol_list', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['FINANCIAL_DATA_TEST_SYMBOL_LIST_ENTID'];
...
//# sourceMappingURL=SymbolListDirect.test.js.map