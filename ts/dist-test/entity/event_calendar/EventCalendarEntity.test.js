...
(0, node_test_1.describe)('EventCalendarEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'event_calendar.' + op, live))
                return;
        }
        ...
        let event_calendar_ref01_data = Object.values(setup.data.existing.event_calendar)[0];
        // LOAD
        const event_calendar_ref01_ent = client.EventCalendar();
        const event_calendar_ref01_match_dt0 = {};
        const event_calendar_ref01_data_dt0 = (await event_calendar_ref01_ent.load(event_calendar_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != event_calendar_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/event_calendar/EventCalendarTestData.json');
    ...
    let idmap = transform(['event_calendar01', 'event_calendar02', 'event_calendar03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['FINANCIAL_DATA_TEST_EVENT_CALENDAR_ENTID'];
...
//# sourceMappingURL=EventCalendarEntity.test.js.map