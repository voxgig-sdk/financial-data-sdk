...
(0, node_test_1.describe)('EsgDataEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'esg_data.' + op, live))
                return;
        }
        ...
        let esg_data_ref01_data = Object.values(setup.data.existing.esg_data)[0];
        // LOAD
        const esg_data_ref01_ent = client.EsgData();
        const esg_data_ref01_match_dt0 = {};
        const esg_data_ref01_data_dt0 = (await esg_data_ref01_ent.load(esg_data_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != esg_data_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/esg_data/EsgDataTestData.json');
    ...
    let idmap = transform(['esg_data01', 'esg_data02', 'esg_data03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['FINANCIAL_DATA_TEST_ESG_DATA_ENTID'];
...
//# sourceMappingURL=EsgDataEntity.test.js.map