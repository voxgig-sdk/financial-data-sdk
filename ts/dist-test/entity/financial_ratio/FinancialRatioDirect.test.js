...
(0, node_test_1.describe)('FinancialRatioDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-financial_ratio', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-financial_ratio', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['FINANCIAL_DATA_TEST_FINANCIAL_RATIO_ENTID'];
...
//# sourceMappingURL=FinancialRatioDirect.test.js.map