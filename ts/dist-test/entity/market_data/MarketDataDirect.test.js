...
(0, node_test_1.describe)('MarketDataDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-market_data', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-market_data', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'FINANCIAL_DATA_TEST_MARKET_DATA_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['FINANCIAL_DATA_TEST_MARKET_DATA_ENTID'];
