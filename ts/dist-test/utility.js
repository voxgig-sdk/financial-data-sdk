...
function envOverride(m) {
    if ('TRUE' === process.env.FINANCIAL_DATA_TEST_LIVE ||
        'TRUE' === process.env.FINANCIAL_DATA_TEST_OVERRIDE) {
    ...
    m.FINANCIAL_DATA_TEST_EXPLAIN = process.env.FINANCIAL_DATA_TEST_EXPLAIN || m.FINANCIAL_DATA_TEST_EXPLAIN;
    return m;
}
