...
class MarketIndexEntity
  ...
  def make
    opts = @_entopts.dup
    MarketIndexEntity.new(@_client, opts)
  end
  ...
  # @return [MarketIndex, Hash] the current MarketIndex data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MarketIndex fields)
  def match_get
  ...
  #
  # @param reqmatch [MarketIndexLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.MarketIndex.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [MarketIndex, Hash] the loaded MarketIndex; raises FinancialDataError on failure
