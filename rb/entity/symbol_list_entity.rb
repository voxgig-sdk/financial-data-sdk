...
class SymbolListEntity
  ...
  def make
    opts = @_entopts.dup
    SymbolListEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [SymbolListListMatch, Hash, nil] match filter (any subset of
  #   SymbolList fields); defaults to nil, treated as an empty match that lists all.
