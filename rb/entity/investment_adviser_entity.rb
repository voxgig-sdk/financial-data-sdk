...
class InvestmentAdviserEntity
  ...
  def make
    opts = @_entopts.dup
    InvestmentAdviserEntity.new(@_client, opts)
  end
  ...
  # @return [InvestmentAdviser, Hash] the current InvestmentAdviser data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of InvestmentAdviser fields)
  def match_get
  ...
  #
  # @param reqmatch [InvestmentAdviserLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.InvestmentAdviser.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [InvestmentAdviser, Hash] the loaded InvestmentAdviser; raises FinancialDataError on failure
