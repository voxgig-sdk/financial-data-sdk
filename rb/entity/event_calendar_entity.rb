...
class EventCalendarEntity
  ...
  def make
    opts = @_entopts.dup
    EventCalendarEntity.new(@_client, opts)
  end
  ...
  # @return [EventCalendar, Hash] the current EventCalendar data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EventCalendar fields)
  def match_get
