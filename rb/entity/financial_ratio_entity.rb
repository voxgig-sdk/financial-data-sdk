...
class FinancialRatioEntity
  ...
  def make
    opts = @_entopts.dup
    FinancialRatioEntity.new(@_client, opts)
  end
  ...
  # @return [FinancialRatio, Hash] the current FinancialRatio data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of FinancialRatio fields)
  def match_get
  ...
  #
  # @param reqmatch [FinancialRatioLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.FinancialRatio.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [FinancialRatio, Hash] the loaded FinancialRatio; raises FinancialDataError on failure
