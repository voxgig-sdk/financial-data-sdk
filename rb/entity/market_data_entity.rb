# FinancialData SDK MarketData entity
...
class MarketDataEntity
  ...
  #
  # @param reqmatch [MarketDataListMatch, Hash, nil] match filter (any subset of
  #   MarketData fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
