...
class MiscellaneousDataEntity
  ...
  def make
    opts = @_entopts.dup
    MiscellaneousDataEntity.new(@_client, opts)
  end
  ...
  # @return [MiscellaneousData, Hash] the current MiscellaneousData data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MiscellaneousData fields)
  def match_get
  ...
  #
  # @param reqmatch [MiscellaneousDataLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.MiscellaneousData.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [MiscellaneousData, Hash] the loaded MiscellaneousData; raises FinancialDataError on failure
