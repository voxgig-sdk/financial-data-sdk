...
class InvestmentAdviserEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set FINANCIAL_DATA_TEST_INVESTMENT_ADVISER_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def investment_adviser_basic_setup(extra)
  ...
  entid_env_raw = ENV["FINANCIAL_DATA_TEST_INVESTMENT_ADVISER_ENTID"]
