...
class MutualFundEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set FINANCIAL_DATA_TEST_MUTUAL_FUND_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def mutual_fund_basic_setup(extra)
  ...
  entid_env_raw = ENV["FINANCIAL_DATA_TEST_MUTUAL_FUND_ENTID"]
