...
class CryptoCurrencyEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set FINANCIALDATA_TEST_CRYPTO_CURRENCY_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def crypto_currency_basic_setup(extra)
  ...
  entid_env_raw = ENV["FINANCIALDATA_TEST_CRYPTO_CURRENCY_ENTID"]
