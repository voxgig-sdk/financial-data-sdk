...
class EventCalendarEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set FINANCIAL_DATA_TEST_EVENT_CALENDAR_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def event_calendar_basic_setup(extra)
  ...
  entid_env_raw = ENV["FINANCIAL_DATA_TEST_EVENT_CALENDAR_ENTID"]
