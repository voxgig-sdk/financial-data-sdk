...
class BasicInformationEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set FINANCIALDATA_TEST_BASIC_INFORMATION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def basic_information_basic_setup(extra)
  ...
  entid_env_raw = ENV["FINANCIALDATA_TEST_BASIC_INFORMATION_ENTID"]
