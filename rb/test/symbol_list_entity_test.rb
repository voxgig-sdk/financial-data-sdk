...
class SymbolListEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set FINANCIALDATA_TEST_SYMBOL_LIST_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def symbol_list_basic_setup(extra)
  ...
  entid_env_raw = ENV["FINANCIALDATA_TEST_SYMBOL_LIST_ENTID"]
