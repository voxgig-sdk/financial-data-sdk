...
func registerSDKWords(r *eng.Registry, client *sdk.FinancialDataSDK) {
...
func runOp(client *sdk.FinancialDataSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
