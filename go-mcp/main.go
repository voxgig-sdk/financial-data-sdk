// Command FinancialData-mcp is an MCP server exposing the FinancialData
// SDK as MCP tools.
//
// Two tools are registered:
//
//	FinancialData_list  — list records of an entity
//	FinancialData_load  — load a single record of an entity
//
